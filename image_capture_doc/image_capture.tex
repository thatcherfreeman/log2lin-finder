...
\subsubsection{Requirements}
\begin{enumerate}
    \item \textbf{Exposure Bracket via Shutter Speed and Aperture} - Change the exposure using shutter speed and aperture so that we can get accurate increments of exposure. It is recommended to start with a 360 degree shutter and wider aperture for the lowest ISO so there is a lot of room to stop down.
